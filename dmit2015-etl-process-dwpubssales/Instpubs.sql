...
begin
  raiserror
('Dropping existing pubs database ....',0,1)
  DROP
database pubs
end
GO
...
where e.emp_id = i.emp_id
  AND i.job_id = j.job_id IF (@job_id = 1) and (@emp_lvl <> 10)
begin
   raiserror
('Job id 1 expects the default level of 10.',16,1)
...
CREATE
CLUSTERED INDEX employee_ind ON employee(lname, fname, minit)
...
where authors.au_id = titleauthor.au_id
  AND titles.title_id = titleauthor.title_id GO
